...
public class XmlBasedDescriber implements Describer {
  ...
  /**
   * The ID which represents {@code this} {@link Describer} in a {@link MuleArtifactDescriber}
   */
  ...
  private Optional<MetadataType> extractType(String type) {
    ...
    Map<String, MetadataType> types = ImmutableMap.<String, MetadataType>builder()
